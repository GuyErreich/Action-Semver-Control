"""
Unit tests for the ChangelogManager class in auto_semver.domain.changelog.manager module.
...
from auto_semver.domain.changelog.manager import _DEFAULT_COMMIT_PLACEHOLDER, ChangelogManager
...
class TestChangelogManagerUpdate:
    ...
    def mock_today(self, mocker: MockerFixture) -> None:
        ...
        mocker.patch("auto_semver.domain.changelog.manager.date", FakeDate)
    ...
    def test_update_empty_messages(
        ...
        # Mock logger
        mock_logger = mocker.patch("auto_semver.domain.changelog.manager.logger")
