"""
Unit tests for the SemverLock class in auto_semver.domain.semver.lock module.
...
from auto_semver.domain.semver.lock import FILE_NAME, SemverLock
...
class TestSemverLockLoadFromFile:
    ...
    def test_load_from_file_real_file(self, mocker: MockerFixture) -> None:
        ...
        try:
            mocker.patch("auto_semver.domain.semver.lock.FILE_NAME", tmp_path)
            lock = SemverLock.load_from_file()
