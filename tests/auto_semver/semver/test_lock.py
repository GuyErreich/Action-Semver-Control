...
import pytest
from auto_semver.semver.lock import SemverLock, FILE_NAME
...
class TestSemverLockFromDict:
    ...
    @pytest.mark.unit
    def test_from_dict_with_complex_version(self):
    ...
    @pytest.mark.unit
    @pytest.mark.edge_case
    def test_from_dict_explicit_none_values(self):
...
class TestSemverLockToDict:
    ...
    @pytest.mark.unit
    def test_to_dict_with_complex_version(self):
...
class TestSemverLockSaveToFile:
    ...
    @pytest.mark.unit
    def test_save_to_file_yaml_options(self):
    ...
    @pytest.mark.unit
    @pytest.mark.edge_case
    def test_save_to_file_exception_handling(self):
...
class TestSemverLockLoadFromFile:
    ...
    def test_load_from_file_success(self):
        ...
        mock_file = mock_open(read_data="dummy")
        with patch("builtins.open", mock_file):
    ...
    @pytest.mark.unit
    @pytest.mark.edge_case
    def test_load_from_file_general_exception(self):
        """Test loading with general exception during processing."""
        mock_file = mock_open(read_data="dummy")
        with patch("builtins.open", mock_file):
            with patch("yaml.safe_load", side_effect=Exception("General error")):
                with pytest.raises(Exception, match="General error"):
                    SemverLock.load_from_file()

    @pytest.mark.integration
    def test_load_from_file_real_file(self):
        ...
        try:
            with patch("auto_semver.semver.lock.FILE_NAME", tmp_path):
                lock = SemverLock.load_from_file()
...
class TestSemverLockRoundTrip:
    ...
    def test_to_dict_from_dict_round_trip(self, test_data):
...
class TestSemverLockEdgeCases:
    ...
    @pytest.mark.edge_case
    def test_empty_branch_names(self):
    ...
    def test_long_branch_names(self):
        ...
        lock = SemverLock(
            version=version,
            source_branch=long_name,
            target_branch=long_name
        )
