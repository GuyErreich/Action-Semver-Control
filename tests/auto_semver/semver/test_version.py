...
class TestVersionInit:
    ...
    @pytest.mark.unit
    def test_initialization_with_zero_versions(self):
...
class TestVersionParse:
    ...
    def test_parse_basic_versions(self, version_string, expected):
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("version_string,expected_prefix", [
        ("v1.2.3", "v"),
        ("1.2.3", None),
    ])
    def test_parse_with_prefix(self, version_string, expected_prefix):
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("version_string,expected_suffix", [
        ("1.2.3-dev", "-dev"),
        ("1.2.3-rc1", "-rc1"),
        ("1.2.3", None),
    ])
    def test_parse_with_suffix(self, version_string, expected_suffix):
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("version_string,expected_quote", [
        ('"1.2.3"', '"'),
        ("'1.2.3'", "'"),
        ("1.2.3", None),
    ])
    def test_parse_with_quotes(self, version_string, expected_quote):
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("version_string,expected_title", [
        ("Version: 1.2.3", "Version: "),
        ("Release-Version: 1.2.3", "Release-Version: "),
        ("1.2.3", None),
    ])
    def test_parse_with_title(self, version_string, expected_title):
    ...
    @pytest.mark.unit
    def test_parse_complex_version_string(self):
    ...
    def test_parse_invalid_version_strings(self, invalid_string):
...
class TestVersionDetectBumpType:
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("branch_name,expected_bump", [
    ...
    def test_detect_bump_type_known_prefixes(self, branch_name, expected_bump):
    ...
    def test_detect_bump_type_unknown_prefixes_default_to_patch(self, branch_name):
    ...
    @pytest.mark.unit
    @pytest.mark.edge_case
    def test_detect_bump_type_case_sensitive(self):
...
class TestVersionBumping:
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("branch_name,expected_version", [
    ...
    def test_bump_by_branch_name(self, branch_name, expected_version):
...
class TestVersionSuffixManagement:
    ...
    @pytest.mark.unit
    def test_set_suffix_replace_existing(self):
    ...
    @pytest.mark.unit
    def test_set_suffix_to_none(self):
    ...
    @pytest.mark.unit
    def test_remove_suffix_when_none(self):
...
class TestVersionStringRepresentation:
    ...
    @pytest.mark.unit
    def test_str_version_with_suffix(self):
        """Test string representation with suffix."""
        version = Version(major=1, minor=2, patch=3, suffix="-dev")
        assert str(version) == "1.2.3-dev"

    @pytest.mark.unit
    def test_str_version_without_suffix(self):
    ...
    @pytest.mark.unit
    def test_format_full_line_no_title(self):
...
class TestVersionMergeFrom:
    ...
    @pytest.mark.unit
    def test_merge_from_preserves_formatting(self):
        """Test that merge_from preserves original formatting attributes."""
        version1 = Version(
            major=1, minor=2, patch=3,
            title="Version: ", prefix="v", quote='"'
        )
    ...
    @pytest.mark.unit
    def test_merge_from_suffix_overwrite(self):
    ...
    @pytest.mark.unit
    def test_merge_from_none_suffix(self):
...
class TestVersionComparison:
    ...
    @pytest.mark.unit
    def test_equality_different_suffixes(self):
    ...
    @pytest.mark.unit
    def test_equality_formatting_ignored(self):
    ...
    @pytest.mark.unit
    @pytest.mark.parametrize("version1_data,version2_data,expected", [
    ...
    def test_less_than_comparison(self, version1_data, version2_data, expected):
    ...
    def test_greater_than_comparison(self, version1_data, version2_data, expected):
    ...
    @pytest.mark.unit
    @pytest.mark.edge_case
    def test_comparison_with_non_version_returns_not_implemented(self):
    ...
    @pytest.mark.unit
    def test_suffix_ignored_in_numerical_comparison(self):
...
class TestVersionEdgeCases:
    ...
    @pytest.mark.edge_case
    def test_empty_string_components(self):
    ...
    @pytest.mark.edge_case
    def test_whitespace_in_parse_input(self):
    ...
    @pytest.mark.edge_case
    def test_version_with_special_characters_in_suffix(self):
